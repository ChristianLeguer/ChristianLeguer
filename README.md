...
2. **[Pruebas de Hipótesis y Análisis de Resultados](https://github.com/ChristianLeguer/Pruebas_A_B_Departamento_Marketing)**  
   - 🎯 **Objetivo**: Identificar el impacto de estrategias de marketing mediante pruebas A/B.  
   - 🛠 **Herramientas**: Python, SQL, Matplotlib.  

3. **[Estudio de Mercado sobre Restaurantes en Los Ángeles](https://github.com/ChristianLeguer/Establecimientos_los_angeles)**  
   - 🎯 **Objetivo**: Analizar datos de restaurantes y su distribución en Los Ángeles para identificar tendencias del mercado.  
   - 🛠 **Herramientas**: Python, Folium, Tableau.

---

## 🎯 **Objetivo Profesional**
"Me apasiona convertir datos complejos en soluciones prácticas para impulsar estrategias empresariales y optimizar procesos. Estoy en constante aprendizaje para mejorar mis habilidades técnicas y explorar nuevas áreas del análisis de datos."
